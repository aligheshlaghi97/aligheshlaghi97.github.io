      ...
      <Container className={`${isVisible ? 'animate-fade-in' : ''}`}
        ...
        <Row>
          ...
          <div className="container-about-me">
            <h4>
             I am a passionate quantitative developer/analyst with experience in Python, Django and FastAPI.
             I love building web applications and exploring new technologies related to financial software solutions.
            </h4>
          </div>
        </Row>
